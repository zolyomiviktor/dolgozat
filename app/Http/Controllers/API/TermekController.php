...
class TermekController extends BaseController
{
    ...
    {
        $termeks = Termek::all();
        return $this->handleResponse(TermekResource::collection($termeks), 'A termékek lekérve!');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->handleResponse(new TermekResource($termek), 'A termék létrehozva!');
    }
    ...
    public function show($id)
    {
        ...
        if (is_null($termek)) {
            return $this->handleError('A termék nem található!');
        }
    ...
    public function update(Request $request, Termek $termek)
    {
        ...
        return $this->handleResponse(new TermekResource($termek), 'A termék sikeresen frissítve!');
    }
